...
public class HttpMultipartClient
{
	...
	// ---------- Constructors
	public HttpMultipartClient(String h, String pth, int p) throws IllegalArgumentException
	{
	...
	public void send() throws IOException
	{
		...
		try
		{
			...
			while ((size = fileStream.read(bytes)) > 0)
			{
				...
				int _progress = Integer.valueOf(Math.round((Float.valueOf(String.valueOf(bytesSent)) / Float.valueOf(String.valueOf(length)) * 100)));
			}
